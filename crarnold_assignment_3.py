...
emergency_contact = ("Mom", "Lauren", "240-472-6669")
home_address = ("124 Woodstaff Ave", "Wake Forest, NC", "27587")
instagram_info = ("Instagram", "@chrisrich2007", 312)
twitter_info = ("Twitter", "@chrisrich2007", 127)
birthday_info = ("Birthday", 8, 27, 20067)
...
print(f"{current_courses[1]} - {course_credits_dict['MATH 131']} credits - {course_professors_dict['MATH 131']} - {course_rooms_dict['MATH 131']}")
print(f"{current_courses[2]} - {course_credits_dict['ENG 119']} credits - {course_professors_dict['ENG 119']} - {course_rooms_dict['ENG 119']}")
print(f"{current_courses[3]} - {course_credits_dict['HIS 103']} credits - {course_professors_dict['HIS 103']} - {course_rooms_dict['HIS 103']}\n")
